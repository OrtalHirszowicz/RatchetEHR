...
N_ITERS = 10000
clf = RandomizedSearchCV(xgboost, params, scoring = 'roc_auc', verbose = 3, n_iter = N_ITERS, n_jobs = 8)
...
for i in range(NUM_EXPERIMENTS):
    ...
    params = {'subsample': 0.4, 'max_leaves': 50, 
              'max_depth': 6, 'lambda': 0.01, 'grow_policy': 'depthwise', 
              'gamma': 2, 'eta': 0.02, 'booster': 'dart', 'alpha': 0.1}
    ...
    update_experiment_results(X_test, y_test_pred, new_y_test, "XGBoost")
